...
class TestCertificate(object):
    def test_created_if_not_exists(self, post, api_get):
        ...
        cert = self._create_default_certificate()
        ...
        pytest.helpers.assert_any_call(post, self._uri(NAMESPACE), call_params)
    ...
    def test_updated_if_exists(self, get, put):
        ...
        from_api.save()
        pytest.helpers.assert_any_call(put, self._uri(NAMESPACE, NAME), call_params)

    def test_deleted(self, delete):
        Certificate.delete(NAME, namespace=NAMESPACE)
        pytest.helpers.assert_any_call(delete, self._uri(NAMESPACE, NAME))
    ...
    def _create_mock_response(self):
        ...
        mock_response.json.return_value = {
            ...
            "metadata": {
                ...
                "namespace": NAMESPACE,
                "resourceVersion": "178",
                "selfLink": self._uri(NAMESPACE, NAME),
    ...
    def _create_default_certificate(self):
