...
class APIService(Model):
    ...
    class Meta:
        create_url = "/apis/apiregistration.k8s.io/v1/apiservices"
        delete_url = "/apis/apiregistration.k8s.io/v1/apiservices/{name}"
        get_url = "/apis/apiregistration.k8s.io/v1/apiservices/{name}"
        list_all_url = "/apis/apiregistration.k8s.io/v1/apiservices"
        update_url = "/apis/apiregistration.k8s.io/v1/apiservices/{name}"
        watch_url = "/apis/apiregistration.k8s.io/v1/watch/apiservices/{name}"
        watchlist_all_url = "/apis/apiregistration.k8s.io/v1/watch/apiservices"

    apiVersion = Field(six.text_type, "apiregistration.k8s.io/v1")
