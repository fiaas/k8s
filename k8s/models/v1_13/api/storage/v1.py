...
from k8s.models.v1_13.api.core.v1 import TopologySelectorTerm
...
class VolumeAttachment(Model):
    ...
    """
    class Meta:
        create_url = "/apis/storage.k8s.io/v1/volumeattachments"
        delete_url = "/apis/storage.k8s.io/v1/volumeattachments/{name}"
        get_url = "/apis/storage.k8s.io/v1/volumeattachments/{name}"
        list_all_url = "/apis/storage.k8s.io/v1/volumeattachments"
        update_url = "/apis/storage.k8s.io/v1/volumeattachments/{name}"
        watch_url = "/apis/storage.k8s.io/v1/watch/volumeattachments/{name}"
        watchlist_all_url = "/apis/storage.k8s.io/v1/watch/volumeattachments"
