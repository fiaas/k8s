...
from k8s.models.v1_13.api.batch.v1 import JobSpec
from k8s.models.v1_13.api.core.v1 import ObjectReference
...
class CronJob(Model):
    ...
    class Meta:
        ...
        get_url = "/apis/batch/v1beta1/namespaces/{namespace}/cronjobs/{name}"
        list_all_url = "/apis/batch/v1beta1/cronjobs"
        list_ns_url = "/apis/batch/v1beta1/namespaces/{namespace}/cronjobs"
        update_url = "/apis/batch/v1beta1/namespaces/{namespace}/cronjobs/{name}"
