...
from k8s.models.v1_13.apimachinery.apis.meta.v1 import ObjectMeta
...
class TokenReviewStatus(Model):
    ...
    audiences = ListField(six.text_type)
...
class TokenReview(Model):
    ...
    class Meta:
        create_url = "/apis/authentication.k8s.io/v1beta1/tokenreviews"

    apiVersion = Field(six.text_type, "authentication.k8s.io/v1beta1")
