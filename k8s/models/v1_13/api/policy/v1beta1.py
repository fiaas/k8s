...
from k8s.models.v1_13.api.core.v1 import SELinuxOptions
from k8s.models.v1_13.apimachinery.apis.meta.v1 import DeleteOptions, LabelSelector, ListMeta, ObjectMeta
...
class RunAsGroupStrategyOptions(Model):
    """
...
class PodSecurityPolicySpec(Model):
    ...
    runAsGroup = Field(RunAsGroupStrategyOptions)
