...
from k8s.models.v1_12.api.core.v1 import PersistentVolumeClaim, PodTemplateSpec
from k8s.models.v1_12.apimachinery.apis.meta.v1 import LabelSelector, ListMeta, ObjectMeta
from k8s.models.v1_12.apimachinery.runtime import RawExtension
...
class StatefulSet(Model):
    ...
    class Meta:
        ...
        get_url = "/apis/apps/v1/namespaces/{namespace}/statefulsets/{name}"
        list_all_url = "/apis/apps/v1/statefulsets"
        list_ns_url = "/apis/apps/v1/namespaces/{namespace}/statefulsets"
        update_url = "/apis/apps/v1/namespaces/{namespace}/statefulsets/{name}"
...
class ReplicaSet(Model):
    ...
    class Meta:
        ...
        get_url = "/apis/apps/v1/namespaces/{namespace}/replicasets/{name}"
        list_all_url = "/apis/apps/v1/replicasets"
        list_ns_url = "/apis/apps/v1/namespaces/{namespace}/replicasets"
        update_url = "/apis/apps/v1/namespaces/{namespace}/replicasets/{name}"
...
class Deployment(Model):
    ...
    class Meta:
        ...
        get_url = "/apis/apps/v1/namespaces/{namespace}/deployments/{name}"
        list_all_url = "/apis/apps/v1/deployments"
        list_ns_url = "/apis/apps/v1/namespaces/{namespace}/deployments"
        update_url = "/apis/apps/v1/namespaces/{namespace}/deployments/{name}"
...
class DaemonSet(Model):
    ...
    class Meta:
        ...
        get_url = "/apis/apps/v1/namespaces/{namespace}/daemonsets/{name}"
        list_all_url = "/apis/apps/v1/daemonsets"
        list_ns_url = "/apis/apps/v1/namespaces/{namespace}/daemonsets"
        update_url = "/apis/apps/v1/namespaces/{namespace}/daemonsets/{name}"
...
class ControllerRevision(Model):
    ...
    class Meta:
        ...
        get_url = "/apis/apps/v1/namespaces/{namespace}/controllerrevisions/{name}"
        list_all_url = "/apis/apps/v1/controllerrevisions"
        list_ns_url = "/apis/apps/v1/namespaces/{namespace}/controllerrevisions"
        update_url = "/apis/apps/v1/namespaces/{namespace}/controllerrevisions/{name}"
